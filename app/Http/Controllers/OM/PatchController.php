...
class PatchController extends Controller
{
    ...
    protected function grid()
    {
        ...
        $grid->script(trans('game.info.script'))->limit(255);
    ...
    protected function form()
    {
        ...
        $form->textarea('script', trans('game.info.script'))->rows(3)->rules('required|max:255');
